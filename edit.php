...
<!--                    <td><input type="checkbox"></td>-->
                    ...
                    <td><a href=update.php?id=<?php echo $row['id'] ?> class="gre"  >修改</a>
                        <a href="delete.php?id=<?php echo $row['id']?>"onclick=" return del()" class="red" >删除</a>
    ...
    <table  align="center"><tr><td>
        ...
        <tr>
            <td colspan="7"><a href="" onclick="return chek()">全选/取消</a> &nbsp;&nbsp;<input type="submit" onclick="return del();" value="删除选择"/></td>
        </tr>
    </table>
    </form>
</div>
