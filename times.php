...
echo "document.write('<div id=\"TimeShow\" align=\"center\" style=\"font-size:12pt;font-family:宋体;  \">?</div>');".$n;
...
echo " TimeShow.innerHTML=y+'年'+m+'月'+d+'日 '+'<font color=red>星期'+ww[w]+'</font>'+hstr+istr+sstr+astr;".$n;
